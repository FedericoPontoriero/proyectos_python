...
def merge_sort(linked_list):
    ...
    Recursively divide the list into sublists containing a single node
...
def merge(left, right):
    ...
    # Create a new linked list that contains nodes from left and right
    merged = LinkedList()
    ...
    while left_head or right_head:
        ...
        # Add the node right to merged linked list
